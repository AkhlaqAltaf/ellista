$(".custom-menu-primary .hs-menu-wrapper>ul>li.hs-item-has-children").mouseenter(function () {
    $("header.header").addClass("active-menu");
}),
    $(".custom-menu-primary .hs-menu-wrapper>ul>li.hs-item-has-children").mouseleave(function () {
        $("header.header").removeClass("active-menu");
    }),
    $(function () {
        $(".cm-header-mega-menu .hs-menu-wrapper>ul li.hs-item-has-children").prepend('<div class="child-trigger"></div>'),
            $(".header-nav__trigger").on("click", function () {
                $(".custom-menu-primary .hs-menu-children-wrapper").slideUp(), $(".child-trigger").removeClass("child-open"), $(".custom-menu-primary").slideToggle(), $("body").toggleClass("menu-open"), $(this).toggleClass("is-open");
            }),
    ...
    $(window).scroll(function () {
        $(this).scrollTop() > 100 ? ($("header.header").addClass("scroll"), $(this).scrollTop() > 200 ? $("header.header").addClass("default") : $("header.header").removeClass("default")) : $("header.header").removeClass("scroll");
    }),
    $(".has-banner").length < 1 ? $("body").addClass("no-banner") : $("body").addClass("has-banner"),
    $(".custom-menu-primary .desktop-menu  .hs-menu-wrapper>ul>li.hs-item-has-children>ul.hs-menu-children-wrapper>li>ul").each(function () {
        var len = $(this).children("li").length;
        $(this).attr("class", "items" + len);
    }),
    ...
    $(".desktop-trigger").on("click", function () {
        $(".cm-header-mega-menu").fadeIn(200);
    }),
    $(".close-icon").on("click", function () {
        $(".cm-header-mega-menu").fadeOut();
    }),
    (function (factory) {
        "use strict";
        ...
        (instanceUid = 0),
            ((Slick = function (element, settings) {
                ...
                (_.defaults = {
                    ...
                    void 0 !== document.mozHidden
                        ...
                        : void 0 !== document.webkitHidden && ((_.hidden = "webkitHidden"), (_.visibilityChange = "webkitvisibilitychange")),
            ...
            (Slick.prototype.checkResponsive = function (initial, forceUpdate) {
                ...
                if (
                    ...
                    for (breakpoint in ((targetBreakpoint = null), _.breakpoints))
                        ...
                        ? null !== _.activeBreakpoint
                            ? (targetBreakpoint !== _.activeBreakpoint || forceUpdate) &&
                              ...
                              "unslick" === _.breakpointSettings[targetBreakpoint]
                                  ...
                                  : ((_.options = $.extend({}, _.originalSettings, _.breakpointSettings[targetBreakpoint])), !0 === initial && (_.currentSlide = _.options.initialSlide), _.refresh(initial)),
                            ...
                            : ((_.activeBreakpoint = targetBreakpoint),
                              ...
                              (triggerBreakpoint = targetBreakpoint))
                        : null !== _.activeBreakpoint &&
                          ((_.activeBreakpoint = null), (_.options = _.originalSettings), !0 === initial && (_.currentSlide = _.options.initialSlide), _.refresh(initial), (triggerBreakpoint = targetBreakpoint)),
            ...
            (Slick.prototype.cleanUpEvents = function () {
                ...
                _.options.dots &&
                    ...
                    !0 === _.options.arrows &&
                        ...
                        !0 === _.options.accessibility && (_.$prevArrow && _.$prevArrow.off("keydown.slick", _.keyHandler), _.$nextArrow && _.$nextArrow.off("keydown.slick", _.keyHandler))),
            ...
            (Slick.prototype.getLeft = function (slideIndex) {
                ...
                return (
                    ...
                    !0 === _.options.variableWidth &&
                        ((targetSlide =
                            _.slideCount <= _.options.slidesToShow || !1 === _.options.infinite ? _.$slideTrack.children(".slick-slide").eq(slideIndex) : _.$slideTrack.children(".slick-slide").eq(slideIndex + _.options.slidesToShow)),
                        ...
                        !0 === _.options.centerMode &&
                            ((targetSlide =
                                _.slideCount <= _.options.slidesToShow || !1 === _.options.infinite
            ...
            (Slick.prototype.getNavigableIndexes = function () {
                var max,
                    ...
                    counter = 0,
                    indexes = [];
                for (!1 === _.options.infinite ? (max = _.slideCount) : ((breakPoint = -1 * _.options.slidesToScroll), (counter = -1 * _.options.slidesToScroll), (max = 2 * _.slideCount)); breakPoint < max; )
            ...
            (Slick.prototype.getSlideCount = function () {
                var swipedSlide,
                    ...
                    _ = this;
                return (
                    (centerOffset = !0 === _.options.centerMode ? _.slideWidth * Math.floor(_.options.slidesToShow / 2) : 0),
            ...
            (Slick.prototype.initArrowEvents = function () {
                ...
                !0 === _.options.arrows &&
                    ...
                    !0 === _.options.accessibility && (_.$prevArrow.on("keydown.slick", _.keyHandler), _.$nextArrow.on("keydown.slick", _.keyHandler)));
            }),
            (Slick.prototype.initDotEvents = function () {
                var _ = this;
                !0 === _.options.dots && _.slideCount > _.options.slidesToShow && ($("li", _.$dots).on("click.slick", { message: "index" }, _.changeSlide), !0 === _.options.accessibility && _.$dots.on("keydown.slick", _.keyHandler)),
                    !0 === _.options.dots &&
                        !0 === _.options.pauseOnDotsHover &&
                        _.slideCount > _.options.slidesToShow &&
            ...
            (Slick.prototype.keyHandler = function (event) {
                ...
                event.target.tagName.match("TEXTAREA|INPUT|SELECT") ||
                    (37 === event.keyCode && !0 === _.options.accessibility
                        ? _.changeSlide({ data: { message: !0 === _.options.rtl ? "next" : "previous" } })
                        : 39 === event.keyCode && !0 === _.options.accessibility && _.changeSlide({ data: { message: !0 === _.options.rtl ? "previous" : "next" } }));
            }),
            (Slick.prototype.lazyLoad = function () {
                ...
                if (
                    (!0 === _.options.centerMode
                        ? !0 === _.options.infinite
                            ? (rangeEnd = (rangeStart = _.currentSlide + (_.options.slidesToShow / 2 + 1)) + _.options.slidesToShow + 2)
                            : ((rangeStart = Math.max(0, _.currentSlide - (_.options.slidesToShow / 2 + 1))), (rangeEnd = _.options.slidesToShow / 2 + 1 + 2 + _.currentSlide))
                        : ((rangeStart = _.options.infinite ? _.options.slidesToShow + _.currentSlide : _.currentSlide),
                          (rangeEnd = Math.ceil(rangeStart + _.options.slidesToShow)),
                          !0 === _.options.fade && (rangeStart > 0 && rangeStart--, rangeEnd <= _.slideCount && rangeEnd++)),
                    ...
                    for (var prevSlide = rangeStart - 1, nextSlide = rangeEnd, $slides = _.$slider.find(".slick-slide"), i = 0; i < _.options.slidesToScroll; i++)
                        prevSlide < 0 && (prevSlide = _.slideCount - 1), (loadRange = (loadRange = loadRange.add($slides.eq(prevSlide))).add($slides.eq(nextSlide))), prevSlide--, nextSlide++;
                ...
                if (
                    ("object" === $.type(arguments[0])
                        ...
                        : "string" === $.type(arguments[0]) &&
                          ((option = arguments[0]), (value = arguments[1]), (refresh = arguments[2]), "responsive" === arguments[0] && "array" === $.type(arguments[1]) ? (type = "responsive") : void 0 !== arguments[1] && (type = "single")),
                    "single" === type)
                )
            ...
            (Slick.prototype.setProps = function () {
                ...
                (_.positionProp = !0 === _.options.vertical ? "top" : "left"),
                    ...
                    void 0 !== bodyStyle.transform && !1 !== _.animType && ((_.animType = "transform"), (_.transformType = "transform"), (_.transitionType = "transition")),
            ...
            (Slick.prototype.setupInfinite = function () {
                ...
                if ((!0 === _.options.fade && (_.options.centerMode = !1), !0 === _.options.infinite && !1 === _.options.fade && ((slideIndex = null), _.slideCount > _.options.slidesToShow))) {
                    for (infiniteCount = !0 === _.options.centerMode ? _.options.slidesToShow + 1 : _.options.slidesToShow, i = _.slideCount; i > _.slideCount - infiniteCount; i -= 1)
                        (slideIndex = i - 1),
                            $(_.$slides[slideIndex])
                                .clone(!0)
                                .attr("id", "")
                ...
                if (((sync = sync || !1), !((!0 === _.animating && !0 === _.options.waitForAnimate) || (!0 === _.options.fade && _.currentSlide === index))))
                    if (
                        ...
                        !1 === _.options.fade &&
                            ...
                            !0 !== dontAnimate && _.slideCount > _.options.slidesToShow
            ...
            (Slick.prototype.startLoad = function () {
                var _ = this;
                !0 === _.options.arrows && _.slideCount > _.options.slidesToShow && (_.$prevArrow.hide(), _.$nextArrow.hide()),
            ...
            (Slick.prototype.swipeDirection = function () {
                ...
                return (
                    ...
                    (swipeAngle <= 45 && swipeAngle >= 0) || (swipeAngle <= 360 && swipeAngle >= 315)
                        ? !1 === _.options.rtl
                            ? "left"
                            : "right"
                ...
                return (
                    ...
                    !(!_.dragging || _.scrolling || (touches && 1 !== touches.length)) &&
                        ...
                        !_.options.verticalSwiping && !_.swiping && verticalSwipeLength > 4
                            ? ((_.scrolling = !0), !1)
                            : (!0 === _.options.verticalSwiping && (_.touchObject.swipeLength = verticalSwipeLength),
                ...
                Math.floor(_.options.slidesToShow / 2),
                    !0 === _.options.arrows &&
                        ...
                        0 === _.currentSlide
                            ...
                            : ((_.currentSlide >= _.slideCount - _.options.slidesToShow && !1 === _.options.centerMode) || (_.currentSlide >= _.slideCount - 1 && !0 === _.options.centerMode)) &&
    ...
    $(".latest-news-slider").slick({
        ...
        speed: 300,
        prevArrow:
            '<div class="prev-arrow"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.7071 18.7071C15.3166 19.0976 14.6834 19.0976 14.2929 18.7071L8.29289 12.7071C7.90237 12.3166 7.90237 11.6834 8.29289 11.2929L14.2929 5.29289C14.6834 4.90237 15.3166 4.90237 15.7071 5.29289C16.0976 5.68342 16.0976 6.31658 15.7071 6.70711L10.4142 12L15.7071 17.2929C16.0976 17.6834 16.0976 18.3166 15.7071 18.7071Z" fill="black"/></svg></div>',
        nextArrow:
            '<div class="next-arrow"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.29289 5.29289C8.68342 4.90237 9.31658 4.90237 9.70711 5.29289L15.7071 11.2929C16.0976 11.6834 16.0976 12.3166 15.7071 12.7071L9.70711 18.7071C9.31658 19.0976 8.68342 19.0976 8.29289 18.7071C7.90237 18.3166 7.90237 17.6834 8.29289 17.2929L13.5858 12L8.29289 6.70711C7.90237 6.31658 7.90237 5.68342 8.29289 5.29289Z" fill="black"/></svg></div>',
        slidesToShow: 1,
        slidesToScroll: 1,
    }),
...
//# sourceURL=https://3017451.fs1.hubspotusercontent-na1.net/hub/3017451/hub_generated/template_assets/135732161375/1731304180408/EuroSystems_Sept2023/js/main.js
