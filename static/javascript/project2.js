!function() {
    ...
    Array.prototype.forEach.call(e, function(e, t) {
        ...
        Array.prototype.forEach.call(e.querySelectorAll("ul li:last-child > a"), function(e, t) {
            e.addEventListener("blur", function(e) {
                if (!this.parentNode.querySelector("ul")) {
                    ...
                    this.parentNode.parentNode.parentNode.querySelector("a").setAttribute("aria-expanded", "false")
                }
            })
        });
    ...
    Array.prototype.forEach.call(t, function(e, t) {
        e.querySelector("a").addEventListener("focus", function(e) {
            var t = document.querySelector(".hs-menu-wrapper.flyouts > ul > li > ul ul.open-menu-list")
              , r = this.parentNode.querySelector("ul");
            if (t) {
                t.removeAttribute("style");
                t.classList.remove("open-menu-list")
